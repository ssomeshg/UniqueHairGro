...
<head>
  ...
  <title>Admin - Unique Hair Gro</title>
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo" style="height:100px;">
          <a href="<?= base_url() . 'dashboard' ?>" class="app-brand-link">
            <img src="<?php echo base_url(); ?>assets\img\logo.jpg" alt="" style="width:100%;">
          </a>
        ...
        <ul class="menu-inner py-1" style="background: #C61A64;">
          ...
          <li class="menu-item ">
            <a href="javascript:void(0);" class="menu-link menu-toggle text-white">
              <i class="menu-icon tf-icons bx bxs-photo-album"></i>
              <div data-i18n="Authentications">Before & After</div>
            </a>
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="<?= base_url() . 'before_after_create' ?>" class="menu-link text-white">
                  <div>create</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="<?= base_url() . 'before_after_list' ?>" class="menu-link text-white">
                  <div>List</div>
                </a>
              </li>
            </ul>
        ...
        <div class="menu-bar">
            <img src="<?php echo base_url() ?>assets/img/pink-menu.png" alt="menu">
          </div>
        </div>
      </aside>
